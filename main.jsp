						...
						<div class="inner">
							<header class="major">
								<!-- 로그인 후 로그인 한 사용자의 세션아이디로 바꾸시오.
									 ex)smart님 환영합니다 -->
								<% if(member==null){%>
									<h1>로그인한 세션 아이디를 출력하세요</h1>
								<% }else{%>
									<h1><%=member.getM_email() %>님 환영합니다!</h1>
								<%} %>
						...
						<div class="inner">
							<section>
								...
								<div class="field half first">
										...
										<input type="text"  id="name" name="name" placeholder="보내는 사람 이름" />
									</div>
									<div class="field half">
										<label for="email">Email</label>
										<input type="text"  id="email" name="email" placeholder="보낼 사람 이메일"/>
									</div>
